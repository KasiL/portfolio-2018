...
<div class="projectNav clearfix">
	...
	<span class="nav-previous"><?php previous_post_link( '%link', '<span class="meta-nav">'. et_get_safe_localization( _x( '&larr;', 'Previous post link', 'Divi' ) ) . '%title </span> ' . $prevthumbnail ); ?></span>
	...
	<?php 	$nextPost = get_next_post();
			$nextthumbnail = get_the_post_thumbnail($nextPost->ID ,array(200,200) );?>
	<span class="nav-next"><?php next_post_link( '%link', $nextthumbnail .'%title <span class="meta-nav">'. et_get_safe_localization( _x( '&rarr;', 'Next post link', 'Divi' ) ) . '</span>' ); ?></span>
</div>
